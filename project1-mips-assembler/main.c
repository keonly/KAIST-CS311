...
void first_pass(FILE *file_ptr, flags *flags, char *binary)
{
	char *input;
...
void second_pass(FILE *file_ptr, flags *flags, char *binary)
{
	char *input;
	int instruction;
	int temp;
...
void third_pass(FILE *file_ptr, flags *flags, char *binary)
{
	char *input;
	ENTRY *found_label;
	int temp;
